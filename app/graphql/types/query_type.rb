...
module Types
  class QueryType < Types::BaseObject
    def initialize(object, context)
      super
      @db = Sequel::Model.db
      # TODO - don't do all this directly in the constructor, we're not animals...
      ...
      @prepared_statement = @db[:edition_links]
    ...
    field :edition, EditionType, null: false, extras: [:lookahead] do
      argument :base_path, String, required: true
    end

    def edition(base_path:, lookahead:)
